...
ShellRoot {
  ...
  property string omarchyPath: Quickshell.env("OMARCHY_PATH") || (home + "/.config/quickshell")
  readonly property string shellPath: Quickshell.env("OMARCHY_PATH") ? (omarchyPath + "/shell") : omarchyPath
