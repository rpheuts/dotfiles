...
hl.env("PATH", "/home/rpheuts/.config/quickshell/bin:" .. (os.getenv("PATH") or ""))
...
hl.config({
    general = {
        ...
        col = {
            active_border   = "rgba(cacccc99)",
            inactive_border = "rgba(45475a44)",
        },
...
-- AGY CLI persistent slide-in overlay window
hl.window_rule({
    name      = "agy-overlay-rule",
    match     = { class = "agy-overlay" },
...
-- Rofi application launcher frosted glass layer rule
hl.layer_rule({
    name  = "rofi-blur",
